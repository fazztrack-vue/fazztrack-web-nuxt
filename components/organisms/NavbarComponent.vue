<template>
  <section
    class="bg-white z-[100] sticky top-0 right-0 left-0 h-20 flex justify-center items-center shadow-1 px-5">
    <!-- <div class="fixed z-60 inset-0 bg-[#494c51] opacity-50"></div> -->
    <nav
      :class="
        widhtContain === 'profile'
      ...
      <main class="hidden lg:flex flex-1 justify-between items-center">
        <section class="flex justify-between items-center font-bold gap-5">
          <div
            ...
            <nav
              v-if="isOpenNav1"
              class="absolute -left-[24px] top-6 z-10 mt-10 bg-white border-[1px] solid border-[#DADCE0] rounded-[8px] p-[24px] flex items-stretch">
              <section class="flex">
                <section>
                  <p
                    class="text-[#b6bac0] font-medium mb-[16px] uppercase whitespace-nowrap">
                    Bootcamp
                  </p>
                  <section class="flex flex-col items-start gap-[6px]">
                    ...
                    <a
                      class="flex items-center font-bold whitespace-nowrap py-[4px]"
                      >Fullstack Website dan Golang</a
                    >
                  </section>
                </section>
              </section>
          ...
          <div class="font-bold cursor-pointer" @click="moveRoute('/hire')">
        ...
        <section class="flex items-center gap-7">
          ...
          <section
            ...
            <nav
              v-if="isAvatarDropdown"
              class="absolute -left-[24px] top-6 mt-10 bg-white border-[1px] solid border-[#DADCE0] rounded-[8px] p-[24px] flex items-stretch">
              <section class="flex flex-col">
                <section class="flex">
                  <div class="profile-avatar">
                    <div
                      data-v-dd33f8c4=""
                      data-v-282fc1c4=""
                      class="flex items-center justify-center min-w-[44px] w-[44px] h-[44px] bg-slate-300 rounded-full">
                    </div>
                  </div>
                  <section class="ml-3 w-36 overflow-hidden">
                    ...
                    <p
                      class="truncate"
                      aria-label="faisalchakiki012018@gmail.com">
                      {{ dataUser?.email }}
                    </p>
                  </section>
                </section>
                ...
                <p
                  class="font-bold mb-[14px] cursor-pointer"
                  @click="moveRoute('/profile/about')">
                  Profile
                </p>
                <p class="font-bold cursor-pointer" @click="handleLogout">
                  Logout
                </p>
              </section>
            </nav>
          ...
          <section v-else class="flex gap-5">
            <button
              type="button"
              class="rounded-[4px] py-[12px] px-[20px] text-p bg-white text-blue-600 border-[1px] border-blue-500 hover:bg-blue-100 focus:shadow-[0_0_0_4px_rgba(73,115,182,0.1)] font-bold text-center outline-none disabled:bg-neutral-300 disabled:text-neutral-600 disabled:border-[1px] disabled:border-neutral-500"
